            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-green-50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-green-600">{analytics.studentsInProgress}</p>
                ...
                <div className="space-y-3">
                  {analytics.topStudents.slice(0, 5).map((student) => (
                    <div key={student.userId} className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
                      ...
                      <Link to={`/teacher/courses/${courseId}/students/${student.userId}`} className="text-green-600 hover:text-green-800">
                    ...
                    <tr key={student.userId} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div className="h-full bg-green-600 rounded-full" style={{ width: `${student.progressPercentage || 0}%` }} />
                          </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link to={`/teacher/courses/${courseId}/students/${student.userId}`} className="p-2 text-green-600 hover:bg-green-50 rounded-lg" title="Xem chi tiết">
                            <Eye className="w-5 h-5" />
                          </Link>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {analytics.lessonAnalytics.map((lesson) => (
                    <tr key={lesson.lessonId} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link to={`/lessons/${lesson.lessonId}`} className="font-medium text-green-600 hover:text-green-800">{lesson.lessonTitle}</Link>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-sm">{lesson.studentsCompleted}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-sm">{lesson.studentsInProgress}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
